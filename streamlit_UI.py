...
from Streamlit_helpers import encode_text_helper
...
tokenizer2 = AutoTokenizer.from_pretrained('saved_model_normal_bert')# change paths with kaggle

model1 = BertModel.from_pretrained('bert-base-uncased')
model2 = DenseRetriever("bert-base-uncased")
model2.load_state_dict(torch.load(os.path.join('saved_model_normal_bert', "best_dense_retriever.pt")))# change paths with kaggle
